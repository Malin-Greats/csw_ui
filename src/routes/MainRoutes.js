...
const AppUserAccountProfileEducation = Loadable(lazy(() => import('views/application/users/account-profile/Profile1/ProfileEducation')));
const AppUserAccountProfileEmploymenet = Loadable(lazy(() => import('views/application/users/account-profile/Profile1/ProfileEmployment')));
...
const AppMemberPublish = Loadable(lazy(() => import('views/application/publish')));
const AppMemberPrint = Loadable(lazy(() => import('views/application/print')));
const AppMemberBooks = Loadable(lazy(() => import('views/application/applications')));
const AppMemberPrintQueue = Loadable(lazy(() => import('views/application/print-queue')));
const AppMemberBlogs = Loadable(lazy(() => import('views/application/blogs/ViewBlogs')));
const AppMemberAddBlog = Loadable(lazy(() => import('views/application/blogs/AddBlog')));
const AppMembers = Loadable(lazy(() => import('views/application/members')));
const AppMemberPayments = Loadable(lazy(() => import('views/application/memberPayments')));
const AppMemberAllApplications = Loadable(lazy(() => import('views/application/allApplications')));
const AppMemberAllBlogs = Loadable(lazy(() => import('views/application/allBlogs')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/user/account-profile/Profile1/profile-education',
            element: <AppUserAccountProfile1 />
        },
        {
            path: '/user/account-profile/Profile1/profile-employment',
            element: <AppUserAccountProfile1 />
        },
        {
            path: '/users/account-profile/profile2',
            element: <AppUserAccountProfile2 />
        },
        {
            path: '/users/account-profile/profile3',
        ...
        {
            path: '/publish',
            element: <AppMemberPublish />
        },
        {
            path: '/print',
            element: <AppMemberPrint />
        },
        {
            path: '/applications',
            element: <AppMemberBooks />
        },
        {
            path: '/print-queue',
            element: <AppMemberPrintQueue />
        },
        {
            path: '/add-blog',
            element: <AppMemberAddBlog />
        },
        {
            path: '/view-blogs',
            element: <AppMemberBlogs />
        },
        {
            path: '/members',
            element: <AppMembers />
        },
        {
            ...
            element: <AppMemberPayments />
        },
        {
            path: '/all-applications',
            element: <AppMemberAllApplications />
        },
        {
            path: '/all-blogs',
            element: <AppMemberAllBlogs />
        },
        {
            path: '/services-fees',
