...
const Payee = () => {
    ...
    const handleChangeApplicationPrice = (event) => {
        setApplicationPrice(event.target.value);
    };
                    ...
                    <form noValidate autoComplete="off" onSubmit={onSubmitPricing}>
                        <Grid container spacing={gridSpacing}>
                            <Grid item xs={12} md={8}>
                                <TextField id="outlined-basic2" fullWidth label="Application Price" name="applicationPrice" type="phone" value={applicationPrice} onChange={handleChangeApplicationPrice}/>
                            </Grid>
