...
const Design = () => {
    ...
    const [designCurrent, setDesignCurrent] = useState(currentApplication)
    ...
    const onSubmit = async(e) => {
        ...
        const res = await fetch(`${url}/member/application-print-update/${currentApplication}`, requestOptions)
